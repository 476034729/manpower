                    ...
                    <div class="position-relative">
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <form id="loinForm" class="form-horizontal"  check="hrmLoginController.do?checkUser"  role="form" action="hrmLoginController.do?login"  method="post">
								...
								<span class="block input-icon input-icon-right">
									<input type="text"  name="job_num" class="form-control" placeholder="请输入工号"  id="job_num" value="11111"/>
