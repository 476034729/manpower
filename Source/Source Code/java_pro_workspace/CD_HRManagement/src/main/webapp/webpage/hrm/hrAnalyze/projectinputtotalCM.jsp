...
// var tdList=document.getElementById("#build_tbody_third").querySelector("td");
    ...
    function build_tbody_once() {
        $.ajax({
            type: 'get',
            url: 'CMProjectInputTotalController.do?getuserlist',
            async: false,
            cache: false,
            success: function (result) {
    ...
    function build_tbody_twice(projectCode, beginMonth, endMonth) {
        $.ajax({
            type: 'get',
            url: 'CMProjectInputTotalController.do?getworkhourinfo',
            data: {
    ...
    function build_tbody_third(code, beginMonth, endMonth) {
        ...
        $.ajax({
            type: 'get',
            url: 'CMProjectInputTotalController.do?getworkhourinfobylevel',
            data: {
                'projectCode': code,
                'year': parseInt(beginTime.split("-")[0]),
                'beginMonth': beginMonth,
