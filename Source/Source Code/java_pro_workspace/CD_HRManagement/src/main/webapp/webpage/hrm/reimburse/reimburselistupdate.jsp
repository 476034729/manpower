...
<div  id="updatereimburse"  >
    <input type="hidden" id="reimburseId" name="reimburseId" value="${reimburseId}" >
    <div >
        <div style="font-size: x-large;">
            ...
            <div>
                <table border="1" cellspacing="0" cellpadding="0" id="restTable" class="table table-bordered">
                    ...
                    <tr height="40px">
                        ...
                        <td class="noneborderboth"><input type="text" id="userName" class="apply_name" name="userName" value="${user.userName}" readonly/>
                        </td>
                        <td class="noneborderboth">工&nbsp;&nbsp;号：</td>
                        <td class="noneborderleft"><input type="text" id="jobNo" class="apply_name" name="jobNo" value="${user.jobNum}"
                                                          style="width:156px;" readonly/></td>
                    </tr>
                    <tr height="40px">
                        <td class="noneborderright">部&nbsp;&nbsp;门：</td>
                        <td class="noneborderboth"><input type="text" id="dept" class="depart_name apply_name" name="dept" value="${user.department}" readonly/></td>
                        <td class="noneborderboth">日&nbsp;&nbsp;期：</td>
                        <td class="noneborderleft">
                            <%--<fmt:formatDate value="${tsReimburse.applyDate}" var="validApplyDate" pattern="yyyy-MM-dd"/>--%>
                            <input type="text" id="currentDate" class="depart_name apply_name" name="currentDate" value="${currentDate}"
                                                          style="width:156px;" readonly/></td>
                    </tr>
                    <tr height="40px">
                        ...
                        <td class="noneborderboth">
                            <div>
                                <select name="projectId" id="projectId" style="width: 55%;height: 25px;" >
                                    <option value="${tsReimburse.projectNmae}">${tsReimburse.projectNmae}</option>
                        ...
                        <td class="noneborderleft">
                            <div>
                                <select name="expendId" id="expendId" style="width: 55%;height: 25px;" >
                                    <option value="${tsReimburse.expendName}">${tsReimburse.expendName}</option>
                                    <c:forEach items="${projectList}" var="var">
                                        <option value="${var.projectName}" >${var.projectName}</option>
                                    </c:forEach>
                                </select>
                    ...
                    <tr height="40px">
                        ...
                        <td class="noneborderboth">
                            <div>
                                <input name="projectCode" id="projectCode" style="width: 55%;height: 25px; " value="${projectCode1}" readonly />
                            </div>
                        </td>
                        <td class="noneborderboth">报销支出项目编号 </td>
                        <td class="noneborderleft">
                            <div>
                                <input name="expendCode" id="expendCode" style="width: 55%;height: 25px;"  value="${projectCode1}" readonly />
                    ...
                    <tr height="40px">
                        ...
                        <td class="noneborderboth">
                            <%--<div>--%>
                                <%--&lt;%&ndash;<fmt:formatDate value="${tsReimburse.startTime}" var="validStartDate" pattern="yyyy-MM-ddThh:mm"/>&ndash;%&gt;--%>
                                <%--<input type="datetime-local" id="startTime" name="startTime"  onblur="countTime(this)" value="${startTime}" style="height:25px;" >--%>
                            <%--</div>--%>
                                <div class='input-group date' id='datetimepicker1' style="width: 1px;" >

                                    <input type='text'  id="startTime" class="form-control" onblur="countTime(this)" style="width: 328px;height: 30px; "  value="${startTime}" />
                    ...
                    <span class="glyphicon glyphicon-calendar"></span>
                        ...
                        <td class="noneborderleft">
                            <%--<div>--%>
                                <%--&lt;%&ndash;<fmt:formatDate value="${tsReimburse.endTime}" var="validEndDate" pattern="yyyy-MM-ddThh:mm"/>&ndash;%&gt;--%>
                                <%--<input type="datetime-local" id="endTime" name="endTime" onblur="countTime(this)" value="${endTime}" style="height:25px;">--%>
                            <%--</div>--%>
                                <div class='input-group date' id='datetimepicker2' style="width: 1px;">

                                    <input type='text' id="endTime" class="form-control" onblur="countTime(this)" style="width: 328px;height: 30px;" value="${endTime}" />
                    ...
                    <tr height="40px">
                        ...
                        <td class="noneborderboth">
                            <input type="text" id="costcenterCode"  name="costcenterCode" style=" border-bottom:2px solid #eee;width:148px;text-align:center;" value="${tsReimburse.costCenterCode}" >
                        </td>
                    ...
                    <tr height="40px">
                        ...
                        <td class="noneborderboth">
                            <div>
                                <select name="countryName" id="countryName" style="width: 55%;height: 25px;">
                                    <option value="${country.allowance_fee}">${tsReimburse.countryName}</option>
                        ...
                        <td class="noneborderleft">
                            <input type="text" id="allowanceFee"  name="allowanceFee" value="${tsReimburse.allowanceFee}" style=" border-bottom:2px solid #eee;width:165px;text-align:center;">
                        </td>
                    </tr>
                    <tr height="40px">
                        <td class="noneborderright">货币类型 </td>
                        <td  class="noneborderboth">
                            <input type="text" id="currency" name="currency" value="${tsReimburse.currency}">
                        </td>
                    </tr>
                </table>
            </div>
            <div>
                <table id="detailsData" class="table table-bordered">
                    ...
                    <tbody id="addbody">
                    <c:forEach items="${tsReimDetails}" var="var">
                        <tr>
                        <td style='width: 140px'><input style="width: 100%;" type='text' value="${var.createDate}"/></td>
                        <td style='width: 140px;'><div><select>" +
                            "<option value='${var.expenseType}'>
                                <c:if test="${var.expenseType==1}">
                                    交通
                                </c:if>
                                <c:if test="${var.expenseType==2}">
                                    酒店
                                </c:if>
                                <c:if test="${var.expenseType==3}">
                                    通讯
                                </c:if>
                                <c:if test="${var.expenseType==4}">
                                    补贴
                                </c:if>
                                <c:if test="${var.expenseType==9}">
                                    其它
                                </c:if>
                            </option>" +
                            "</select></div></td>
                        <td ><input style='width:100%' type='text' value="${var.details}"/></td>
                        <td style='width: 100px;'><input type='text'  value="${var.costFee}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
...
<script>
    ...
    $("#add_button").click(function (){
        ...
        var map={
            ...
            countryName:$("#countryName").find("option:selected").text(),
        ...
        $.ajax({
            type: "POST",
            url: "reimburseController.do?updateReimburse",
            ...
            success:function (message) {
                alert("提交成功"+JSON.stringify(message.msg));
