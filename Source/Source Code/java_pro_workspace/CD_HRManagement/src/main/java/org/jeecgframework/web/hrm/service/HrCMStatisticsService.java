...
@Service
@Transactional
public interface HrCMStatisticsService extends CommonService {
    ...
    Map<String,Map<String,Object>> getTimeOfCodeOrderBySerialNum(int year, int month, List<TSUser> users);
